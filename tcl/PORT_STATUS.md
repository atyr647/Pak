...
| Array `&arr` / slice / for-in / struct `=` / by-addr args / sret | `mips_codegen.tcl` | `tcl/tools/array_addr_test.tcl` | place-addr, aggregate assign/args, sret returns, slice-of-slice |
