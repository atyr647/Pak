...
.LCircle_perimeter_ret_1:
	...
	.section .text
	.globl Shape_from_Circle
	.type Shape_from_Circle, @function
Shape_from_Circle:
    sw $a1, 0($a0)
    la $t0, _pak_Shape_vtable_Circle
    sw $t0, 4($a0)
    jr $ra
    nop
	.size Shape_from_Circle, . - Shape_from_Circle
...
.LRect_perimeter_ret_3:
	...
	.section .text
	.globl Shape_from_Rect
	.type Shape_from_Rect, @function
Shape_from_Rect:
    sw $a1, 0($a0)
    la $t0, _pak_Shape_vtable_Rect
    sw $t0, 4($a0)
    jr $ra
    nop
	.size Shape_from_Rect, . - Shape_from_Rect
...
.Lf325:
	...
	.section .data
	.align 2
	.globl _pak_Shape_vtable_Circle
_pak_Shape_vtable_Circle:
	.word Circle_area
	.word Circle_perimeter
	.align 2
	.globl _pak_Shape_vtable_Rect
_pak_Shape_vtable_Rect:
	.word Rect_area
	.word Rect_perimeter
	.align 2
	.globl sink_f
